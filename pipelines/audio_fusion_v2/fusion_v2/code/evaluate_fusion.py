"""Run portable clear_pipeline on bundled features; assert sealed Macro F1."""
...
def main() -> dict:
    ...
    seal_path = _ROOT / "fusion_v2" / "results" / "CLAIM_SEAL.json"
    sealed_metrics_path = _ROOT / "fusion_v2" / "results" / "final_test_metrics.json"
