"""One-shot robot: locked 0.837 contact + hand-selected protect-trunk material bias."""
    ...
    result = {
        ...
        **proto.metrics_bundle(yt, pred_rows),
        "invariants": {
            ...
            "robot_uda": False,
            "protect_trunk_bias": True,
            "cascade_surrogate_hand_selection": True,
            "locked_0837_contact": True,
        },
    }
    proto.write_final_metrics(
        OUT / "multimodal_085_protect_trunk_bias_final_test_metrics.json", result
    )
